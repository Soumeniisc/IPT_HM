...
U_list = [0.0,0.4,0.7,1.0,1.4,1.8,2.2,2.6,3.0,3.4,3.8,4.2,4.6,5.0,5.2,5.3,5.4,5.5,5.6,5.7,5.8,5.9,6.0,6.1,6.2,6.3,6.4,6.5,6.6,6.7,6.8,6.9,7.0]
#U_list = [6.6,6.7,6.8,7.0]
for i, U in enumerate(U_list):
	...
	N_tau=1024*4        # number of imaginary-time steps 2^11	
	...
	copy("Gf", "Gf_U%s_beta%s"%(U_i,beta))
        copy("Gf_tau", "Gf_tau_U%s_beta%s"%(U_i,beta))
	...
	copy("density", "density_U%s_beta%s"%(U_i,beta))
        copy("observables", "observables_U%s_beta%s"%(U_i,beta))
